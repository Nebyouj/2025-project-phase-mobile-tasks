...
void main() {
  ...
  group('getCachedProducts', () {
    test(
      'should return List<ProductModel> from SharedPreferences when present',
      () async {
        // arrange
        when(
          mockSharedPreferences.getString(cachedProducts),
    ...
    test(
      'should throw CacheException when no cached data is present',
      () async {
        // arrange
